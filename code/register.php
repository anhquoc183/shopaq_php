...
<?php
    ...
    if (isset($_REQUEST['Email_User'])){
        ...
        $Address_User = stripslashes($_REQUEST['Password_User']);
        $Address_User = mysqli_real_escape_string($conn,$Address_User);
        $Phone_user = stripslashes($_REQUEST['Phone_User']);
        $Phone_User = mysqli_real_escape_string($conn,$Phone_user);
        ...
        if (mysqli_num_rows($Query_Users) > 0){
            ...
            $Statement_Users = "INSERT INTO `users` (Email_User, Password_User,Address_User, Name_User, Phone_user , Date_Join_User) VALUES ('$Email_User', '$Password_User', '$Address_User', '$Name_User', ' $Phone_user',  '$date')";
            $Query_Users = mysqli_query($conn,$Statement_Users);
            if($Query_Users){
            ...
            <div class="col-12">
                <div class="login-information pb-150">
                    ...
                    <form action="" method="post" class="login-form">
                        ...
                        <div class="text-field">
                            <input type="text" placeholder="Phone" class="form-control" name="Phone_User">
                        </div>
                        <div class="text-field">
                            <input type="text" placeholder="Address" class="form-control" name="Address_User">
                        </div>
