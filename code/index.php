...
<div class="shop-page another-page pt-65">
    <div class="container">
        <div class="row">
            ...
            <div class="categorie-title">                        <h4><i class="flaticon-layers"></i>Tìm kiếm theo</h4>
                        ...
                        <form method="GET" action=""> 
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class=" form-control" name="s" placeholder="Product Name">
                                </div>
                                <div class="col-6">
            ...
            else if(isset($_GET['min']) and isset($_GET['max']))
            {
                $min = $_GET['min'];
                $max = $_GET['max'];
                $Statement_Product = "SELECT * from product where Price_Product >= $min and Price_Product <= $max";
                $resultcou = mysqli_query($conn, $Statement_Product);
                ...
                $start = ($current_page - 1) * $limit;
                $sqls= "SELECT * FROM product WHERE Price_Product >= $min and Price_Product <= $max LIMIT $start,$limit";
                $result = mysqli_query($conn, $sqls);
